...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [15] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(5),
  ...
  [23] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record, 2, 0, 0),
...
TS_PUBLIC const TSLanguage *tree_sitter_jsonl(void) {
